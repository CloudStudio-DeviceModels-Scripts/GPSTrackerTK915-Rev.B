...
# Configuration Script – GPS Tracker TK915 - Rev. B

This **Configuration** script is designed for the **GPS Tracker TK915** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – GPS Tracker TK915 Rev. B

Este script de **Configuration** está diseñado para el modelo **GPS Tracker TK915** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
